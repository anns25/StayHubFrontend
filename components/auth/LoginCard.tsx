...
export default function LoginCard() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (data.token) {
        cookieUtils.setToken(data.token, rememberMe);
        cookieUtils.setUser(data.user, rememberMe);
      }
    ...
    <div className="bg-ivory-light rounded-2xl shadow-lg p-8 w-full max-w-md">
      ...
      <div className="space-y-3 mb-6">
        ...
        <button
          ...
          className="w-full flex items-center justify-center space-x-3 bg-gray-900 hover:bg-gray-800 text-white font-medium py-3 px-4 rounded-lg transition-colors"
        >
